...
=====================================================
 AverFrameWork v1.0
 Filename:    SocketExtentions.cs
 Author:      Zeng Zhiwei
 Time:        2019/12/9 17:57:03
=====================================================
*/
#endregion
...
public static class SocketExtensions
{
    ...
    public static string GetHost(this Socket socket)
    {
        return socket.LocalEndPoint.ToString();
    }

    public static string GetRemoteHost(this Socket socket)
    {
